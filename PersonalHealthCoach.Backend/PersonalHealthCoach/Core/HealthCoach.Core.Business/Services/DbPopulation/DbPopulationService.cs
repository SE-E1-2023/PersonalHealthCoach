    ...
    private async Task PopulatePersonalData()
    {
        ...
        var personalDataList = new List<Result<PersonalData>>
        {
            PersonalData.Create(users[0].Id, PersonalDataConstants.MinimumDateOfBirth, 70.0f, 175f,
                ...
                new List<string> {"Anxiety"},PersonalDataConstants.AllowedGoals.ElementAt(4),
            ...
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,80.0f,165f,
                ...
                new List<string> {"Running", "Swimming"}, 2000, 5, "F", now.AddDays(0)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,75.5f,165f,
                new List<string> { "Diabetes", "Depression", "High blood pressure"},
                new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0),
                new List<string> {"Running", "Swimming"}, 12000, 9, "F", now.AddDays(-1)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,70.5f,165f,
                new List<string> { "Diabetes", "Depression", "High blood pressure"},
                new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0),
                new List<string> {"Running", "Swimming"}, 7000, 9, "F", now.AddDays(-2)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,75.5f,165f,
                new List<string> { "Diabetes", "Depression", "High blood pressure"},
                new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0),
                new List<string> {"Running", "Swimming"}, 12000, 5, "F", now.AddDays(-3)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,75.0f,165f,
                new List<string> { "Diabetes", "Depression", "High blood pressure"},
                new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0),
                new List<string> {"Running", "Swimming"}, 10000, 10, "F", now.AddDays(-4)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,70.5f,165f, new List<string> { "Diabetes", "Depression", "High blood pressure"}, new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0), new List<string> {"Running", "Swimming"}, 7000, 9, "F", now.AddDays(-5)),
            PersonalData.Create(users[2].Id,PersonalDataConstants.MinimumDateOfBirth,65.5f,165f, new List<string> { "Diabetes", "Depression", "High blood pressure"}, new List<string> {"Back pain"},PersonalDataConstants.AllowedGoals.ElementAt(0), new List<string> {"Running", "Swimming"}, 2000, 9, "F", now.AddDays(-6)),
            ...
            PersonalData.Create(users[3].Id,PersonalDataConstants.MinimumDateOfBirth,80.5f,175f, new List<string> {"Asthma", "Diabetes", "High blood pressure"}, new List<string> {"Anxiety"},PersonalDataConstants.AllowedGoals.ElementAt(0), new List<string> { "Boxing", "Cycling"}, 12000, 10, "F", now.AddDays(-5)),
            PersonalData.Create(users[3].Id,PersonalDataConstants.MinimumDateOfBirth,80.5f,175f, new List<string> {"Asthma", "Diabetes", "High blood pressure"}, new List<string> {"Anxiety"},PersonalDataConstants.AllowedGoals.ElementAt(0), new List<string> { "Boxing", "Cycling"}, 12000, 10, "F", now.AddDays(-6)),
